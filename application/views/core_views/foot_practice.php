    ...
    <script type="text/javascript" src="<?php echo base_url('resources/bucky/bucky_jq.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('resources/bucky/bucky_js.js'); ?>"></script>
 </body>
