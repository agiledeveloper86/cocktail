...
<body>
    ...
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script><script>window.jQuery || document.write'<script src ="<?php echo base_url('resources/js/vendor/jquery-1.9.0.min.js'); ?>"><\/script>')</script>
